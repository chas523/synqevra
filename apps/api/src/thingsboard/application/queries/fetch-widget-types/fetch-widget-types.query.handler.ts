...
export class FetchWidgetTypesQueryHandler implements IQueryHandler<
  FetchWidgetTypesQuery,
  Result<WidgetTypesPageDto, ThingsboardApiException>
> {
  constructor(
  ...
  async execute(
    query: FetchWidgetTypesQuery,
  ): Promise<Result<WidgetTypesPageDto, ThingsboardApiException>> {
    try {
