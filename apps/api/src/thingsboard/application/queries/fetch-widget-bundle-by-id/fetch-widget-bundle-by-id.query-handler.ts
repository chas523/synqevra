...
export class FetchWidgetBundleByIdQueryHandler implements IQueryHandler<
  FetchWidgetBundleByIdQuery,
  Result<WidgetBundleDto, ThingsboardApiException>
> {
  constructor(
  ...
  async execute(
    query: FetchWidgetBundleByIdQuery,
  ): Promise<Result<WidgetBundleDto, ThingsboardApiException>> {
    try {
