...
export class FetchWidgetTypeByIdQueryHandler
    implements IQueryHandler<FetchWidgetTypeByIdQuery, Result<WidgetTypeDto, ThingsboardApiException>> {
    constructor(
        @Inject(THINGSBOARD_API_PORT)
        private readonly thingsboardApi: ThingsboardApiPort,
    ) { }

    async execute(query: FetchWidgetTypeByIdQuery): Promise<Result<WidgetTypeDto, ThingsboardApiException>> {
        try {
