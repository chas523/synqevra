...
export class ExportImageQueryHandler implements IQueryHandler<
  ExportImageQuery,
  Result<ImageExportDto, ThingsboardApiException>
> {
  constructor(
  ...
  ): Promise<Result<ImageExportDto, ThingsboardApiException>> {
    try {
