...
export class StorageService implements OnModuleInit {
    ...
    constructor(private configService: ConfigService) {
        ...
        this.bucket = this.configService.get<string>('minio.bucket') || 'public-assets';

        this.logger.log(`Initializing S3/MinIO client against endpoint: ${endpoint}`);
    ...
    async uploadFile(
        ...
        const defaultFilename = customFilename || `${uuidv4()}${path.extname(file.originalname)}`;
