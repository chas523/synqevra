...
export const SlackSettingsForm = ({
  ...
  useEffect(() => {
    ...
    if (initialSettings?.deliveryMethodsConfigs?.MOBILE_APP) {
      setFirebaseFileName(
        initialSettings.deliveryMethodsConfigs.MOBILE_APP
          ...
          <InfoTooltip
            content={
              <div className="space-y-2">
                ...
                <p>
                  You need a Slack Bot Token to send notifications to Slack
                  channels.
                </p>
              </div>
            }
        ...
        >
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Enter your Slack Bot OAuth Token. You can create one in the Slack
              API dashboard.
            </p>
          </div>
