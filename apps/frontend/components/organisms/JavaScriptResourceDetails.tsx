    ...
    <div className="space-y-6">
      ...
      {!isEditing && (
        <div className="flex flex-wrap gap-2">
          <Button
            variant="outline"
            className="bg-[#1f2937] text-white hover:text-white hover:bg-[#374151] border-none"
        ...
        <div className="grid gap-1.5">
          ...
          <div className="text-sm font-medium dark:text-white">
            {fullResource?.resourceSubType
              ? fullResource.resourceSubType.charAt(0).toUpperCase() +
                fullResource.resourceSubType.slice(1).toLowerCase()
              : "-"}
          </div>
        </div>
