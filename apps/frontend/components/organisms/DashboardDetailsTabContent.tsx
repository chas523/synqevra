...
export function DashboardDetailsTabContent({
  ...
  const publicLink = publicId
    ? `${baseUrl}/dashboard/${dashboard.id.id}?publicId=${publicId}`
    : "";
  ...
  const readOnlyInputClass =
    "bg-slate-50/50 border-slate-200 dark:bg-slate-900/10 dark:border-slate-800 text-slate-600 dark:text-slate-400 font-medium";
      ...
      <div className="space-y-4">
        {!isEdit && isPublic && publicLink && (
          <div className="space-y-2">
            <Label className="text-gray-500 dark:text-gray-400 font-normal">
              Public link
            </Label>
            <div className="flex items-center gap-2">
              <Input
                ...
                value={publicLink}
                className={cn(
                  "h-10 pointer-events-none transition-all duration-200",
                  readOnlyInputClass,
                )}
              />
              <Button
            ...
            <div className="flex gap-4">
              <div className="w-32 h-32 border border-gray-200 dark:border-slate-700 rounded bg-white dark:bg-slate-900/50 flex flex-col items-center justify-center text-center p-2 group relative overflow-hidden transition-all duration-200 shadow-inner">
                {dashboard.image ? (
                    ...
                    {dashboard.image.includes("/api/images/") ? (
                      <img
                        src={getImagePreviewUrl(
                          dashboard.image.replace("tb-image;", ""),
                        )}
                        alt="Dashboard"
                      ...
                      <div className="flex flex-col items-center justify-center h-full w-full px-2 text-center text-slate-500 overflow-hidden">
                        ...
                        <span className="text-[10px] break-all line-clamp-4 leading-tight">
                          {dashboard.image.replace("tb-image;", "")}
                        </span>
                      </div>
                    )}
                  ...
                  <>
                    <span className="text-[11px] text-gray-500 dark:text-gray-400 mb-2">
                      No image selected
                    </span>
              ...
              {isEdit && (
                <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <span className="text-xs text-[#2A456C] dark:text-blue-300 font-medium text-center">
                      Browse from gallery
                    </span>
                  </Button>
                  <Button
