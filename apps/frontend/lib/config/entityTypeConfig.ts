...
const EXPORT_ATTRIBUTES: EntityExportOption = {
  key: "saveAttributes",
  label: "Export attributes",
  defaultValue: true,
};
const EXPORT_RELATIONS: EntityExportOption = {
  key: "saveRelations",
  label: "Export relations",
  defaultValue: false,
};
const EXPORT_CREDENTIALS: EntityExportOption = {
  key: "saveCredentials",
  label: "Export credentials",
  defaultValue: true,
};
const EXPORT_CALCULATED_FIELDS: EntityExportOption = {
  key: "saveCalculatedFields",
  label: "Export calculated fields",
  defaultValue: true,
};
