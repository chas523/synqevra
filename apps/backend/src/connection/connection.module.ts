...
import { Connection } from './infrastructure/persistence/connection.entity';
...
import { ConnectionRepositoryAdapter } from './infrastructure/persistence/connection.repository.adapter';
