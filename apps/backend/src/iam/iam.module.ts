...
import { Admin } from './infrastructure/persistence/admin.entity';
import { ActivationLink } from './infrastructure/persistence/activation-link.entity';
import { Patient } from './infrastructure/persistence/patient.entity';
import { PatientMedplum } from './infrastructure/persistence/patient-medplum.entity';
...
import { ActivationLinkRepositoryAdapter } from './infrastructure/persistence/activation-link.repository.adapter';
...
import { PatientMedplumRepositoryAdapter } from './infrastructure/persistence/patient-medplum.repository.adapter';
