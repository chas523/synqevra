...
export function DeviceAlarmsTabContent({ deviceId }: DeviceAlarmsTabContentProps) {
            ...
            },
            {
                ...
                render: (alarm) => {
                    ...
                    return (
                        <Badge
                            variant="outline"
                            className={isCleared ? "text-slate-500" : "text-amber-600 border-amber-200"}
                        >
                            {alarm.status}
                        </Badge>
                    );
    ...
    return (
        <div className="space-y-4">
            ...
            <DataTable
                ...
                emptyMessage="No alarms found for this device."
