                    ...
                    <InfoTooltip
                        content={
                            <div className="space-y-2">
                                <p>Configure base URL settings for your ThingsBoard instance.</p>
                                <p>The Base URL is used for generating links in emails and notifications.</p>
                            </div>
                        }
                    />
                </CardAction>
                ...
                >
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Base URL is used to generate all internal links and for public API access.
                        </p>
                    </div>
