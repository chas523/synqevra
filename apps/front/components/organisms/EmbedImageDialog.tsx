...
export function EmbedImageDialog({
  ...
  const imageUrl =
    usePublicLink && image.publicLink ? image.publicLink : image.link;
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              Using the following code snippet, you may embed an image into the
              components based on the plain HTML. Such components include HTML
              card widgets, cell content functions, etc.
            </p>
            <div className="relative bg-slate-100 dark:bg-slate-800 rounded-lg p-3">
              <code className="text-sm break-all dark:text-slate-200">
                {htmlEmbed}
              </code>
              <Button
                variant="ghost"
          ...
          <div className="space-y-3">
            <h3 className="font-semibold dark:text-white">
              Embed to Angular HTML template
            </h3>
            <p className="text-sm text-muted-foreground">
              Using the following code snippet, you may embed an image into the
              Angular HTML template that will be used for components. Such
              components include the Markdown widget, HTML section in the widget
              editor, custom actions, etc.
            </p>
            <div className="relative bg-slate-100 dark:bg-slate-800 rounded-lg p-3">
              <code className="text-sm break-all dark:text-slate-200">
                {angularEmbed}
