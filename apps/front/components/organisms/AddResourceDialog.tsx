...
export const AddResourceDialog = ({
    ...
    const handleAdd = async () => {
        ...
        reader.onload = async () => {
            ...
            const resource: ResourceCreateRequest = {
                title: selectedTypeOption?.requiresTitle ? title : file.name.split(".")[0],
                resourceType,
                fileName: file.name,
                data: base64,
            };
    ...
    const acceptedExtensions = selectedTypeOption?.acceptedExtensions.join(",") || "";

    return (
        <Dialog open={open} onOpenChange={handleClose}>
            <DialogContent className="sm:max-w-[500px]">
                <DialogHeader className="flex flex-row items-center justify-between">
                    <DialogTitle className="text-black dark:text-white">Add resource</DialogTitle>
                ...
                <div className="space-y-4 py-4">
                    ...
                    <div className="space-y-2">
                        <Label className="text-black dark:text-white">
                            {resourceType === "LWM2M_MODEL" ? "Resource files*" : "Resource file*"}
                        </Label>
                        <FileDropzone
                ...
                <DialogFooter>
                    <Button variant="ghost" onClick={handleClose} className="text-black dark:text-white dark:bg-slate-800">
                        Cancel
                    </Button>
