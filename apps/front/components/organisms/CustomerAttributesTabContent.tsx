...
interface CustomerAttributesTabContentProps {
  customerId: string;
}
...
export function CustomerAttributesTabContent({
  customerId,
}: CustomerAttributesTabContentProps) {
  ...
  const {
    ...
    isLoading,
    mutate,
  } = useSWR(customerId ? ["customerAttributes", customerId] : null, async () =>
    AssetService.fetchCustomerServerAttributes(customerId),
  );
  ...
  const handleAddAttribute = async () => {
    ...
    setIsSaving(true);
    try {
      await AssetService.updateCustomerServerAttributes(customerId, {
        [key]: parsedValue,
      });
      await mutate();
      ...
      <DataTable
        ...
        emptyMessage={
          searchQuery.trim()
            ...
            : "No server attributes found for this customer."
        }
      ...
      >
        <DialogContent className="sm:max-w-130">
          <DialogHeader>
            ...
            <DialogDescription>
              Define a key and value to add a server attribute for this
              customer.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-2">
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-[160px_1fr]">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="customer-attribute-value">Value*</Label>
                <Input
            ...
            <div className="space-y-1.5">
              <Label htmlFor="customer-attribute-key">Key*</Label>
              <Input
                id="customer-attribute-key"
                value={attributeKey}
