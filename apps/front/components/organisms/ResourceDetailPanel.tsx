    ...
    const detailsContent = (
        <div className="space-y-6">
            <div className="border-b border-slate-200 dark:border-slate-700/50 pb-4">
                <label className="text-sm text-muted-foreground dark:text-slate-300">Resource type*</label>
            ...
            <div className="border-b border-slate-200 dark:border-slate-700/50 pb-4">
                <label className="text-sm text-muted-foreground dark:text-slate-300">Title*</label>
                <p className="text-lg font-medium mt-1 dark:text-white">
            ...
            <div className="pb-4">
                <label className="text-sm text-muted-foreground dark:text-slate-300">File name*</label>
                <p className="text-lg font-medium mt-1 dark:text-white">{resource.fileName}</p>
            </div>
        </div>
    );
