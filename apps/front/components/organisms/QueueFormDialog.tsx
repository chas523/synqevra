      ...
      if (queue) {
        reset({
          ...
          duplicateMsgToAllPartitions:
            !!queue.additionalInfo?.duplicateMsgToAllPartitions,
    ...
    try {
      const payload: Queue = {
        ...
        processingStrategy: {
          ...
          maxPauseBetweenRetries:
            values.processingStrategy.maxPauseBetweenRetries,
        },
        additionalInfo: {
      ...
      if (!payload.topic) {
        ...
        payload.topic =
          queue?.topic ||
          `tb_rule_engine.${values.name}`.replace(/\s+/g, "_").toLowerCase();
      }
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                {submitStrategyType === "BATCH" && (
                  <div className="space-y-2">
                    ...
                    <Input
                      type="number"
                      id="batchSize"
                      {...register("submitStrategy.batchSize")}
                    />
                  </div>
                )}
              </div>
          ...
          <div className="border-b">
            <SectionHeader
              title="Retries processing settings"
              section="retries-settings"
            />
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        type="number"
                        {...register("processingStrategy.retries")}
                      />
                    </div>
                    <div className="space-y-2">
                      <Label className="text-xs text-muted-foreground">
                      ...
                      <Input
                        type="number"
                        {...register("processingStrategy.failurePercentage")}
                      />
                    </div>
                    <div className="space-y-2">
                      <Label className="text-xs text-muted-foreground">
                      ...
                      <Input
                        type="number"
                        {...register("processingStrategy.pauseBetweenRetries")}
                      />
                    </div>
                    <div className="space-y-2">
                      <Label className="text-xs text-muted-foreground">
              ...
              <div className="pb-4 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      type="number"
                      {...register("packProcessingTimeout")}
                    />
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-2 p-4 bg-muted/50 rounded-lg">
            ...
            <p className="text-xs text-muted-foreground">
              Custom queue (topic) creation properties, e.g.
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              This text will be displayed in the Queue description instead of
