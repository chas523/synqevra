...
export const GlobalWhitelabelForm = () => {
    ...
    const handleUpload = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await TenantService.uploadGlobalWhitelabelImages(formData);
    ...
    return (
        <Card className="w-full">
                    ...
                    <InfoTooltip
                        content={
                            <div className="space-y-2">
                                ...
                                <p>These will be used if a tenant has not configured their own logos.</p>
                            </div>
                        }
                    />
                </CardAction>
            ...
            <CardContent className="space-y-6 pt-6">
                <form id={formId} onSubmit={handleUpload} className="space-y-6 flex flex-col">
                    <div className="space-y-2">
