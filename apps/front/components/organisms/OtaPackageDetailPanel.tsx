...
export const OtaPackageDetailPanel = ({
  ...
  const { isChecking, isSaving, checkAccess, saveSettings } =
    useManageRepoSettings();
  ...
  const detailsContent = (
    <div className="space-y-6">
      ...
      <div className="border-b border-slate-200 dark:border-slate-700/50 pb-4">
        <label className="text-xs text-muted-foreground italic dark:text-slate-400">
          Version tag
        </label>
        <p className="text-sm font-medium mt-1 dark:text-white">
          {otaPackage.tag || "-"}
      ...
      <div className="border-b border-slate-200 dark:border-slate-700/50 pb-4">
        ...
        <p className="text-sm font-medium mt-1 text-primary dark:text-blue-400">
          {deviceProfileName}
        </p>
      </div>
      ...
      {(otaPackage.checksumAlgorithm || otaPackage.checksum) && (
        <div className="grid grid-cols-2 gap-4 border-b border-slate-200 dark:border-slate-700/50 pb-4">
          ...
          <div>
            ...
            <p className="text-sm font-medium mt-1 dark:text-white break-all">
              {otaPackage.checksum || "-"}
            </p>
          </div>
        </div>
      ...
      {(otaPackage.fileName || otaPackage.dataSize !== null) && (
        <div className="grid grid-cols-3 gap-4 border-b border-slate-200 dark:border-slate-700/50 pb-4">
          ...
          <div>
            ...
            <p className="text-sm font-medium mt-1 dark:text-white">
              {formatFileSize(otaPackage.dataSize)}
            </p>
          </div>
          <div>
            <label className="text-xs text-muted-foreground dark:text-slate-400">
      ...
      {otaPackage.url && (
        <div className="border-b border-slate-200 dark:border-slate-700/50 pb-4">
          ...
          <p className="text-sm font-medium mt-1 text-primary dark:text-blue-400 break-all">
            {otaPackage.url}
          </p>
        </div>
      )}
