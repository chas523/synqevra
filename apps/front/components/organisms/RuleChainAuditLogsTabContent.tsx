...
interface RuleChainAuditLogsTabContentProps {
  ruleChainId: string;
}

export function RuleChainAuditLogsTabContent({
  ruleChainId,
}: RuleChainAuditLogsTabContentProps) {
  ...
  const { data, isLoading, mutate } = useSWR(
    ruleChainId
      ...
      : null,
    () =>
      RuleChainService.getRuleChainAuditLogs(
        ruleChainId,
        page,
        pageSize,
        "createdTime",
  ...
  const handleOpenDetails = useCallback((row: RuleChainAuditLog) => {
  ...
  const columns: DataTableColumn<RuleChainAuditLog>[] = useMemo(
    () => [
      {
        key: "createdTime",
        header: "Created time",
      ...
      <DataTable
        ...
        emptyMessage={
          isSearching
            ...
            : "No audit logs found for this ruleChain."
        }
