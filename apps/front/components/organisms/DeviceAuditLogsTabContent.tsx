...
interface DeviceAuditLogsTabContentProps {
  deviceId: string;
}

export function DeviceAuditLogsTabContent({
  deviceId,
}: DeviceAuditLogsTabContentProps) {
  ...
  const { data, isLoading, mutate } = useSWR(
    deviceId
      ...
      : null,
    () =>
      DeviceService.getDeviceAuditLogs(
        deviceId,
        page,
        pageSize,
        "createdTime",
  ...
  const handleOpenDetails = useCallback((row: DeviceAuditLog) => {
  ...
  const columns: DataTableColumn<DeviceAuditLog>[] = useMemo(
    () => [
      {
        key: "createdTime",
        header: "Created time",
  ...
  return (
    <div className="space-y-4">
      ...
      <DataTable
        ...
        emptyMessage="No audit logs found for this device."
