...
export function DeviceRelationsTabContent({ deviceId }: DeviceRelationsTabContentProps) {
    const [direction, setDirection] = useState<"FROM" | "TO">("FROM");

    const { data: relations, isLoading, mutate } = useSWR(
    ...
    return (
        <div className="space-y-4">
            ...
            <DataTable
                ...
                isLoading={isLoading}
                onRefresh={() => mutate()}
                emptyMessage="No relations found for this device."
