...
interface DeviceRelationsTabContentProps {
  deviceId: string;
}

export function DeviceRelationsTabContent({
  deviceId,
}: DeviceRelationsTabContentProps) {
  ...
  const {
    ...
    deviceId ? ["deviceRelations", deviceId, direction] : null,
    async () => {
      return DeviceService.getDeviceRelations(deviceId, direction);
    },
  );
  ...
  const columns: DataTableColumn<any>[] = useMemo(
          ...
          return (
            <Button
              ...
              onClick={async (e) => {
                ...
                setDeletingKey(key);
                try {
                  await DeviceService.deleteDeviceRelation(deviceId, {
    ...
    [deletingKey, direction, deviceId, mutate],
  );
  ...
  return (
    <div className="space-y-4">
      ...
      <DataTable
        ...
        emptyMessage={
          searchQuery.trim()
            ...
            : "No relations found for this device."
        }
      ...
      <AddRelationDialog
        ...
        onSave={async (params) => {
          await DeviceService.saveDeviceRelation(deviceId, params);
          mutate();
        }}
      />
    </div>
