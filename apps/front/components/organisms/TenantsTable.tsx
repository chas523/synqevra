...
export function TenantsTable({
  ...
  if (isLoading) {
    return (
      <div
        className={cn(
          "bg-white dark:bg-slate-900/60 rounded-xl border border-slate-200 dark:border-slate-700/50",
          className,
        )}
      >
        <Table>
  ...
  if (tenants.length === 0) {
    return (
      <div
        className={cn(
          "bg-white dark:bg-slate-900/60 rounded-xl border border-slate-200 dark:border-slate-700/50 p-8 text-center",
          className,
        )}
      >
        <p className="text-slate-500 dark:text-slate-400">
          Brak tenantów do wyświetlenia
        </p>
      </div>
    );
  }
  ...
  return (
    <div
      className={cn(
        "bg-white dark:bg-slate-900/60 rounded-xl border border-slate-200 dark:border-slate-700/50 overflow-hidden",
        className,
      )}
    >
      <Table>
