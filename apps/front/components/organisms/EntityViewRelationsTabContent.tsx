...
interface EntityViewRelationsTabContentProps {
  entityViewId: string;
}

export function EntityViewRelationsTabContent({
  entityViewId,
}: EntityViewRelationsTabContentProps) {
  ...
  const {
    ...
    entityViewId ? ["entityViewRelations", entityViewId, direction] : null,
    async () => {
      return EntityViewService.getEntityViewRelations(entityViewId, direction);
    },
  );
  ...
  const columns: DataTableColumn<any>[] = useMemo(
          ...
          return (
            <Button
              ...
              onClick={async (e) => {
                ...
                setDeletingKey(key);
                try {
                  await EntityViewService.deleteEntityViewRelation(
                    entityViewId,
                    {
    ...
    [deletingKey, direction, entityViewId, mutate],
  );
  ...
  return (
    <div className="space-y-4">
      ...
      <DataTable
        ...
        emptyMessage={
          searchQuery.trim()
            ...
            : "No relations found for this entity view."
        }
      ...
      <AddRelationDialog
        ...
        onSave={async (params) => {
          await EntityViewService.saveEntityViewRelation(entityViewId, params);
          mutate();
        }}
      />
    </div>
