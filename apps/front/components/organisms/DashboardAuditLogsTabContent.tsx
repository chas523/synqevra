...
interface DashboardAuditLogsTabContentProps {
  dashboardId: string;
}

export function DashboardAuditLogsTabContent({
  dashboardId,
}: DashboardAuditLogsTabContentProps) {
  ...
  const { data, isLoading, mutate } = useSWR(
    dashboardId
      ...
      : null,
    () =>
      DashboardService.getDashboardAuditLogs(
        dashboardId,
        page,
        pageSize,
        "createdTime",
      ...
      <DataTable
        ...
        emptyMessage={
          isSearching
            ...
            : "No audit logs found for this dashboard."
        }
