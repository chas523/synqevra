    ...
    <div className="flex flex-col h-full space-y-6 pt-2">
      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-4 h-32">
          <div className="w-32 h-32 border border-border dark:border-gray-800 rounded-md flex items-center justify-center bg-muted dark:bg-slate-900 overflow-hidden relative group">
            {widgetType.image ? (
              <>
                <img
                ...
                <button
                  onClick={clearImage}
                  className="absolute top-1 right-1 p-1 bg-background/80 dark:bg-black/50 rounded-full opacity-0 group-hover:opacity-100 transition-opacity hover:bg-background dark:hover:bg-black text-muted-foreground hover:text-destructive"
                >
                  <X size={14} />
                </button>
              </>
          ...
          <div className="flex-1 grid grid-cols-2 gap-4">
            <Button
              variant="outline"
              className="h-full flex flex-col gap-2 items-center justify-center text-primary hover:text-primary/90 hover:bg-primary/10 dark:text-blue-400 dark:hover:bg-blue-900/20 border-dashed"
      ...
      <div className="space-y-2 pt-4 border-t border-border/50 dark:border-gray-800">
        <Label>Settings form selector</Label>
        <div className="p-3 bg-muted dark:bg-slate-900 rounded-md border border-border dark:border-gray-800 text-sm text-muted-foreground">
          Default
        </div>
      </div>
      ...
      <div className="space-y-4 pt-4 border-t border-border/50 dark:border-gray-800">
        <div className="flex items-center space-x-2">
