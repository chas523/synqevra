...
import { SelectAdmin as Select, SelectTrigger, SelectValue, SelectContent, SelectItem } from '@/components/ui/admin_select';
...
export function PropertyDialog({ open, onOpenChange, property, onSave, existingIds }: PropertyDialogProps) {
            ...
            <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto">
                ...
                <div className="space-y-4 py-4">
                    <div className="space-y-2">
                        ...
                        />
                        {isIdTaken && !property && <p className="text-xs text-red-500">ID already exists</p>}
                    </div>
                        ...
                        {formData.type === 'boolean' ? (
                            <div className="flex items-center space-x-2">
                                <Switch
                                    ...
                                    onCheckedChange={(checked) => handleChange('defaultValue', checked ? 'true' : 'false')}
                                />
                                <span className="text-sm text-gray-500">{formData.defaultValue === 'true' ? 'True' : 'False'}</span>
                            </div>
                        ) : (
                            <Input
                    ...
                    <Accordion type="single" collapsible className="w-full">
                        <AccordionItem value="advanced">
                            <AccordionTrigger className="text-sm font-medium">Advanced UI settings</AccordionTrigger>
                            <AccordionContent className="space-y-4 pt-2">
                                ...
                                <div className="flex items-center space-x-2">
                                    <Switch
                                        ...
                                        onCheckedChange={(checked) => handleChange('verticalDivider', checked)}
                                    />
                                    <Label htmlFor="verticalDivider">Vertical divider after</Label>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(val: string) => handleChange('disableOnProperty', val === '__none__' ? '' : val)}
                                    >
                                        <SelectTrigger>
                                        ...
                                        <SelectContent>
                                            ...
                                            {existingIds.filter(id => id !== formData.id).map(id => (
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative border rounded-md min-h-[100px] bg-gray-50 dark:bg-slate-900">
                                        ...
                                        <textarea
                                            ...
                                            onChange={(e) => handleChange('displayCondition', e.target.value)}
