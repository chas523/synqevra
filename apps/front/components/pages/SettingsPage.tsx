...
import { Bell, GitBranch, RefreshCw, BarChart3, Sparkles, Link2Off } from "lucide-react";
...
import { useRepoSettingsInfo, useRepoSettings, useManageRepoSettings } from "@/hooks/thingsboard/version-control/useVersionControl";
...
function RepositoryTab() {
    ...
    const { settings, isLoading: isLoadingSettings, mutate: mutateSettings } = useRepoSettings(isConfigured);
        ...
        <div className="bg-white dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/50 rounded-xl p-6 shadow-sm">
            ...
            <div className="flex items-center gap-6 mb-6">
                ...
                <label className="flex items-center gap-2 cursor-pointer shrink-0">
                    ...
                    <span className="text-sm text-red-500 dark:text-red-400 font-medium select-none">Enable Trendz</span>
                </label>
