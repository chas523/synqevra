                            ...
                            data.data.map((profile) => {
                                ...
                                return (
                                    <div
                                        ...
                                        onKeyDown={(e) => e.key === "Enter" && handleProfileClick(profile)}
                                        className={cn(
                                        ...
                                        <div className="flex items-start justify-between">
                                            ...
                                            <div className="ml-4 flex items-center gap-4">
                                                <div className="flex flex-col items-end">
                                                    <span className="text-xs text-slate-400 uppercase tracking-wider font-semibold mb-1">Default</span>
                                                    <div
                                                        className={cn(
                                                    ...
                                                    >
                                                        {profile.default && <Check className="h-3.5 w-3.5" />}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
