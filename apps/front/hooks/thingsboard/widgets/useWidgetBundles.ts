...
export const useWidgetBundles = (
    ...
    const { data, error, isLoading, mutate } = useSWR<WidgetBundlesPage>(
        ['widgetBundles', page, pageSize, sortProperty, sortOrder, tenantOnly, fullSearch, scadaFirst],
        () => WidgetService.getWidgetBundles(page, pageSize, sortProperty, sortOrder, tenantOnly, fullSearch, scadaFirst),
        {
