...
const Content = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center max-w-md p-6 bg-red-50 border border-red-200 rounded-lg">
            <h2 className="text-xl font-semibold text-red-800 mb-2">Unauthorized</h2>
  ...
  if (error || !data) {
    return (
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center max-w-md p-6 bg-red-50 border border-red-200 rounded-lg">
            <h2 className="text-xl font-semibold text-red-800 mb-2">Token Validation Error</h2>
  ...
  if (isValid === false) {
    return (
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center max-w-md p-6 bg-red-50 border border-red-200 rounded-lg">
            <h2 className="text-xl font-semibold text-red-800 mb-2">Invalid Token</h2>
            <p className="text-red-600">
              The provided token is invalid or has expired. Please check your activation link and try again.
            </p>
          </div>
        </div>
    );
...
export default function ActivateAccount() {
  return (
      <Suspense fallback={<div className="flex items-center justify-center min-h-screen"><LoadingOverlayInformation text="Loading..." /></div>}>
        <Content />
      </Suspense>
  );
}