...
export const SUBMIT_STRATEGY_OPTIONS: StrategyOption[] = [
  ...
  },
  {
    ...
    label: "Sequential by originator",
    description:
...
export const PROCESSING_STRATEGY_OPTIONS: StrategyOption[] = [
  {
    ...
    label: "Retry failed and timeout",
    description: "Retry all failed and timed-out messages from processing pack",
  },
  {
    value: "SKIP_ALL_FAILURES",
    label: "Skip all failures",
    description: "Ignore all failures",
  },
  {
    value: "SKIP_ALL_FAILURES_AND_TIMEOUTS",
    label: "Skip all failures and timeouts",
    description: "Ignore all failures and timeouts",
  },
  {
    value: "RETRY_ALL",
    label: "Retry all",
    description: "Retry all messages from processing pack",
  },
  {
    value: "RETRY_FAILED",
    label: "Retry failed",
    description: "Retry all failed messages from processing pack",
  },
  {
    value: "RETRY_TIMED_OUT",
    label: "Retry timeout",
    description: "Retry all timed-out messages from processing pack",
  },
];
